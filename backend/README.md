...
## Project Structure
    ...
    ├── testapiautosetting_123658  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_123658`
...
2. Clone this repo and `cd testapiautosetting_123658`
